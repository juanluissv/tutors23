...
const SYSTEM_PROMPT = [
	...
	'libro de texto escolar (en formato PDF, con texto, tablas, gráficos e',
	'imágenes) en una lección estructurada en JSON.',
	'Lee TODO el capítulo, todas las páginas, e incluye todo el contenido',
	'relevante. Reconstruye los párrafos completos (une las líneas cortadas por',
	'el ajuste de línea del PDF). Conserva el idioma original (normalmente',
	'español) y no inventes datos que no aparezcan en el documento.',
].join(' ')
