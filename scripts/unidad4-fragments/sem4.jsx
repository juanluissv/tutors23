...
<<<VIDEO_BLOCK>>>
								...
								<div className='unidad-activities-grid'>
									<div className='unidad-activity-card'>
										...
										<h3 className='unidad-activity-title'>
								...
								<section>
									...
									<p className='unidad-activity-text'>a. Responde.</p>
									<ul className='unidad-activity-list'>
										<li>
											¿Cómo consideras que era la vida de
											quienes fueron separados por el muro que
											se construyó en Berlín?
										</li>
										<li>
											¿Qué impacto consideras que tuvo el muro
											de Berlín en la vida de las personas?
										</li>
										<li>
											¿Por qué motivó a las personas a buscar
											formas de escapar de la RDA?
										</li>
										<li>
											¿Con qué otros eventos históricos de
											división y conflicto en el mundo se podría
											comparar la edificación del muro de Berlín?
										</li>
										<li>
											¿Consideras que en la actualidad ocurren
											situaciones similares a la construcción del
											muro de Berlín? ¿Por qué?
										</li>
									</ul>
									<p className='unidad-activity-text'>
										b. Elabora una nube de conceptos en la que
										relaciones diferentes ideas sobre las
										consecuencias sociales de la construcción del
										Muro de Berlín. Puedes guiarte con el siguiente
										ejemplo:
									</p>
								</section>
								...
								<div className='unidad-activities-grid'>
									<div className='unidad-activity-card'>
										...
										<p className='unidad-activity-text'>
											Desarrollen la habilidad de conciencia
											histórica temporal. Para ello, respondan:
										</p>
										<ul className='unidad-activity-list'>
											<li>
												a. ¿Como afectó la Guerra Fría a la
												sociedad alemana?
											</li>
											<li>
												b. ¿De qué manera la construcción del
												muro refleja la tensión global durante la
												Guerra Fría?
											</li>
											<li>
												c. ¿De qué manera el muro de Berlín cambió
												la forma de vida de la población alemana?
											</li>
										</ul>
									</div>
								</div>
								...
								<div className='unidad-activities-grid'>
									<div className='unidad-activity-card'>
										...
										<p className='unidad-activity-text'>
											Desarrollen la habilidad de empatía histórica.
											Para ello:
										</p>
										<p className='unidad-activity-text'>
											a. Trabajen con el documento 3 y elaboren un
											cuadro comparativo como el siguiente:
										</p>
										<p className='unidad-activity-text'>
											b. Respondan: ¿Consideran que es posible
											encontrar un equilibrio entre las libertades
											individuales y la igualdad social? Argumenten su
											respuesta.
										</p>
									</div>
								</div>
								...
								<div className='unidad-activities-grid'>
									<div className='unidad-activity-card'>
										...
										<p className='unidad-activity-text'>
											Desarrollen la habilidad de interpretación de
											fuentes. Para ello:
										</p>
										<p className='unidad-activity-text'>
											a. Busquen en internet imágenes de Berlín
											occidental después de la construcción del muro y
											elaboren un mural digital.
										</p>
										<p className='unidad-activity-text'>
											b. Reflexionen a partir de las preguntas: ¿Qué
											aspectos de la vida cotidiana se destacan en las
											imágenes? ¿Cómo influyó la división de la ciudad en
											la experiencia diaria de sus habitantes?
										</p>
									</div>
								</div>
								...
								<div className='unidad-activities-grid'>
									<div className='unidad-activity-card'>
										...
										<p className='unidad-activity-text'>
											Elabora un esquema con las principales diferencias
											y similitudes de la forma de vida entre los
											residentes de Berlín. Puedes guiarte con el
											siguiente ejemplo:
										</p>
									</div>
									<div className='unidad-activity-card'>
										...
										<p className='unidad-activity-text'>
											Organicen un debate sobre la caracterización de la
											vida cotidiana de las personas que vivieron en
											Berlín. Para ello deben:
										</p>
										<ul className='unidad-activity-list'>
											<li>
												a. Dividir la clase en dos grupos: el grupo 1
												representará a Berlín occidental y el grupo 2
												representará a Berlín oriental.
											</li>
											<li>
												b. Recopilar información y analizar diferentes
												aspectos de la vida cotidiana en Berlín durante
												la Guerra Fría, como el acceso a educación,
												vivienda, salud, cultura, oportunidades
												laborales, libertades políticas, entre otros
												aspectos relevantes.
											</li>
											<li>
												c. Designar un moderador para dirigir el debate,
												quien también puede hacer preguntas adicionales
												para profundizar en los temas discutidos.
											</li>
											<li>
												d. Presentar durante el debate sus hallazgos y
												argumentos para caracterizar la vida cotidiana
												en Berlín. Es importante utilizar fuentes
												primarias y secundarias para respaldar los puntos
												de vista.
											</li>
											<li>
												e. Finalizar el debate con una síntesis de los
												puntos más importantes discutidos y las
									...
									<div className='unidad-activity-card'>
										...
										<p className='unidad-activity-text'>
											Elaboren una propuesta para construir una sociedad
											más justa y equitativa en el Berlín de la Guerra
											Fría. Esta debe integrar los aspectos y las ideas
											más relevantes de ambos sistemas políticos.
										</p>
										<p className='unidad-activity-text'>
											a. Presenten la propuesta al resto de la clase y
											generen una discusión sobre los resultados,
											enfatizando en la importancia de la protección de
