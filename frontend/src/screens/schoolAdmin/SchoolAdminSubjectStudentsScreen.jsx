...
const StatusDot = ({ isActive }) => (
	<span
		className={
			`ts-status-dot ${
				isActive ? 'ts-status-dot--active' : 'ts-status-dot--inactive'
			}`
		}
	>
...
function SchoolAdminSubjectStudentsScreen () {
	...
	const {
		...
		error,
		refetch,
	} = useGetSubjectStudentsForSchoolAdminQuery(subjectId, {
...
export default SchoolAdminSubjectStudentsScreen
