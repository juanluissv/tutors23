...
const PlayIconLarge = () => (
	...
	>
		...
		<path d='M19 15l14 9-14 9V15z' fill='url(#saa-play-lg)' />
		<defs>
			<linearGradient
				id='saa-play-lg'
				x1='19'
...
function SchoolAdminWatchAnswerScreen () {
	...
	const {
		...
		error,
		refetch,
	} = useGetSchoolAdminAnswerByIdQuery(answerId, {
		skip: !canFetch || !schoolAdminInfo,
	})

	const videoSrc =
		answer?.mediaId && String(answer.mediaId).trim() !== ''
			? `${ANSWERS_URL}/schooladmin/${answerId}/video`
			: null
...
export default SchoolAdminWatchAnswerScreen
