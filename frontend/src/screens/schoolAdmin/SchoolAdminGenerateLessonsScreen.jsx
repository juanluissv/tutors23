...
const DocumentPdfGlyph = () => (
	...
	>
		<path
			...
			fill='url(#generate-lessons-doc-pdf-fill)'
		/>
		<path
			d='M14 2v6h6'
			stroke='#0284c7'
		...
		<defs>
			<linearGradient
				id='generate-lessons-doc-pdf-fill'
				x1='4'
				y1='2'
				x2='20'
				y2='22'
									...
									{!hasDocuments ? null : isLoadingSubjects || isLoadingLessons ? (
										...
										<div className='book-chapters__select-doc-prompt'>
											...
											<p className='book-chapters__select-doc-prompt-text'>
												...
												arriba para generar lecciones de
												sus capítulos.
											</p>
										</div>
									) : filteredChapters.length === 0 ? (
										<div className='book-chapters__empty-chapters'>
											...
											<p className='book-chapters__empty-chapters-text'>
												Define rangos de páginas por
												capítulo y genera PDFs en la
												página de capítulos del libro
												primero.
											</p>
											<Link
																...
																>
																	...
																	<div className='generate-lessons__chapter-missing-body'>
																		...
																		<p className='generate-lessons__chapter-missing-text'>
																			Genera el PDF de este
																			capítulo en la página de
																			capítulos del libro antes
																			de crear lecciones.
																		</p>
																		<Link
																			to={`/schooladmins/bookchapters/${subjectId}`}
															...
															{isThisGenerating ? (
																...
																>
																	...
																	<p className='generate-lessons__generating-hint'>
																		Leyendo texto, tablas y
																		gráficos del PDF con IA. Esto
									...
									{hasGeneratedLessons ? (
										...
										>
											...
											<span className='subject-book-tools__body'>
												...
												<span className='subject-book-tools__hint'>
													Sube video del tutor y subtítulos
													por capítulo
												</span>
											</span>
											<span
										...
										>
											...
											<span className='subject-book-tools__body'>
												...
												<span className='subject-book-tools__hint'>
													Requiere al menos una lección web
													generada
												</span>
											</span>
										</span>
