...
const BookGlyph = () => (
	...
	>
		<path
			...
			fill='url(#teacher-view-book-fill-a)'
		/>
		<path
			d='M13 4h5a2 2 0 012 2v10a2 2 0 01-2 2h-5V4z'
			fill='url(#teacher-view-book-fill-b)'
		/>
		<path
			d='M12 4v16'
			stroke='url(#teacher-view-book-stroke)'
			strokeWidth='1.5'
			strokeLinecap='round'
		/>
		<defs>
			<linearGradient
				id='teacher-view-book-fill-a'
				x1='4'
				y1='4'
				x2='11'
				y2='18'
...
const DocumentPdfGlyph = () => (
	...
	>
		<path
			...
			fill='url(#teacher-view-book-doc-pdf-fill)'
		/>
		<path
			d='M14 2v6h6'
			stroke='#0284c7'
		...
		<defs>
			<linearGradient
				id='teacher-view-book-doc-pdf-fill'
				x1='4'
				y1='2'
				x2='20'
				y2='22'
...
function TeacherViewBookScreen () {
						...
						<div className='center-content2 login-screen login-screen--wide'>
							<div className='login-card book-chapters view-book'>
								...
								<section
									...
									aria-labelledby='teacher-view-book-lessons-heading'
								>
									<div className='book-chapters__list-header'>
										<div>
											<h2
												id='teacher-view-book-lessons-heading'
												className='book-chapters__section-title'
											>
												2. Capítulos
											</h2>
											<p className='book-chapters__section-desc'>
												{selectedDocument
													...
													: 'Selecciona un documento arriba para ver sus capítulos.'}
											</p>
										</div>
										{rows.length > 0 ? (
...
export default TeacherViewBookScreen
